...
export default function Wall(){
    ...
    return(
        <section>
            ...
            {showDeleteMessageModal ? <DeleteMessageModal close={()=>hideDeleteModal("message")} message_id={messageIdDelete} onSubmitMessageDelete={submitMessageDelete}/> : ""} 
            {showDeleteCommentModal ? <DeleteCommentModal close={()=>hideDeleteModal("comment")} comment_id={commentIdDelete[1]} message_id={commentIdDelete[0]} onSubmitCommentDelete={submitCommentDelete}/> : ""} 
        </section>
    );
}