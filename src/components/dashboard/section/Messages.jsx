...
export default function Messages(props){
    ...
    function displayPostComment(){ showPostComment ? setShowPostComment(false) : setShowPostComment(true)}

    function displayEdit(){
        update_message_button.current.disabled=false;
        setDisabled({...disabled,update_button:false});
        showEdit ? setShowEdit(false) : setShowEdit(true); edit_message_textarea.current.value=props.message;
    }
